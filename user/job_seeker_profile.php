    ...
    <div class="social-media-section">
      ...
      <div class="social-icons">
        <?php if (!empty($user['facebook_link'])): ?>
          <a href="<?= htmlspecialchars($user['facebook_link']) ?>"><i class="fab fa-facebook-f"></i></a>
        <?php endif; ?>
        <?php if (!empty($user['twitter_link'])): ?>
          <a href="<?= htmlspecialchars($user['twitter_link']) ?>"><i class="fab fa-twitter"></i></a>
        <?php endif; ?>
        <?php if (!empty($user['linkedin_link'])): ?>
          <a href="<?= htmlspecialchars($user['linkedin_link']) ?>"><i class="fab fa-linkedin-in"></i></a>
        <?php endif; ?>
        <?php if (!empty($user['reddit_link'])): ?>
          <a href="<?= htmlspecialchars($user['reddit_link']) ?>"><i class="fab fa-reddit-alien"></i></a>
        <?php endif; ?>
        <?php if (!empty($user['instagram_link'])): ?>
          <a href="<?= htmlspecialchars($user['instagram_link']) ?>"><i class="fab fa-instagram"></i></a>
        <?php endif; ?>
        <?php if (!empty($user['youtube_link'])): ?>
          <a href="<?= htmlspecialchars($user['youtube_link']) ?>"><i class="fab fa-youtube"></i></a>
        <?php endif; ?>
      </div>
    </div>
...
foreach ($experienceRecords as $exp) {
    ...
    $end = (!empty($exp['end_date'])) ? new DateTime($exp['end_date']) : new DateTime(); // If end_date is NULL, assume currently working
...
// Fetch Highest Education Degree
...
<div class="profile-info-card">
  <div class="profile-info-grid">
    <div class="info-item">
      ...
      <div>
        ...
        <p><?= htmlspecialchars(date('d M, Y', strtotime($user['date_of_birth']))) ?></p>
      </div>
    </div>
    <div class="info-item">
    ...
    <div class="info-item">
      ...
      <div>
        ...
        <p><?= htmlspecialchars($user['marital_status'] ?? 'Single') ?></p>
      </div>
    </div>
    <div class="info-item">
  ...
  <p>
    <?= htmlspecialchars($highestDegree['level_name'] ?? 'Unknown Level') ?> - 
    <?= htmlspecialchars($highestDegree['degree_title'] ?? 'N/A') ?>
  </p>
</div>
    ...
    <div class="contact-card">
      ...
      <div class="contact-item">
        ...
        <div class="contact-text">
          ...
          <p><?= htmlspecialchars($user['website'] ?? '-') ?></p>
        </div>
      </div>
      <div class="contact-item">
      ...
      <div class="contact-item">
        ...
        <div class="contact-text">
          ...
          <?php if (!empty($user['secondary_phone'])): ?>
            <span class="label">SECONDARY PHONE</span>
            <p><?= htmlspecialchars($user['secondary_phone']) ?></p>
          <?php endif; ?>
        </div>
      </div>
      <div class="contact-item">
